...
import dtos.Book;
import dtos.BookWithJsonCreatorAndJsonProperty;
import utils.JsonUtils;

public class ScenarioWithJsonCreatorAndJsonProperty {
    public static Results execute() {
        final int numberOfIterations = 5000;
        
        final BookWithJsonCreatorAndJsonProperty book = new BookWithJsonCreatorAndJsonProperty(
            1, "9781484256251", "Spring Boot Persistence Best Practices: Optimize Java Persistence Performance in Spring Boot Applications"
        );
